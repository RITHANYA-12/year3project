  ...
  useEffect(() => {
    ...
    if (user?.location && outburstEvents.length > 0) {
      const isNearby = outburstEvents.some((event) => {
        ...
        return distance <= 20; // 20 kilometers radius
      });
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-md p-4 flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600 mt-1">
                    {currentLocation ? (
                      <>
                        <span className="font-medium">Latitude:</span> {currentLocation.latitude.toFixed(6)}<br />
            ...
            <div className="lg:col-span-2">
              <Card>
                ...
                <div className="h-[500px]">
                  <MapComponent
                    lat={currentLocation?.latitude || 20.5937}
                    lng={currentLocation?.longitude || 78.9629}
                    zoom={6}
                  />
                </div>
              </Card>
